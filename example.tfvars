...
listorgpols             = ["<ENTER CONSTRAINTS HERE COMMA SEPARATED, LEAVE EMPTY IF NONE>"] # org policy constraints to allow all in the project - allow all / deny all / custom type org policies
